(function () {
  ...
  function addConditionRow() {
    ...
    const del = document.createElement('button'); del.type = 'button'; del.className = 'ghost small-btn trash-btn'; del.textContent = '🗑️';
  ...
  function createUpdateRow(schema, preset) {
    ...
    const btn = document.createElement("button"); btn.type = "button"; btn.className = "ghost small-btn trash-btn"; btn.textContent = "🗑️";
